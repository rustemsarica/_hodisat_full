...
class ChatController extends Controller
{
    ...
    {
        $conversations = Conversation::where('sender_id', auth()->user()->id)->orWhere('receiver_id', auth()->user()->id)->latest('id')->paginate(10);
    ...
    public function create_conversation(Request $request)
    {
        ...
        return response()->json([
            ...
            'shop_name' => $conversation->receiver->user_type == 'admin' ? 'In House Product' : $conversation->receiver->username,
