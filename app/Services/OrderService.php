...
class OrderService{
    ...
    public function create_shipping_code($id) {
        ...
        try{
            ...
            DB::table('logs')->insert(['title'=>'order services create code','text'=>json_encode($response->kabulEkle2Response,JSON_UNESCAPED_UNICODE)]);
            return $response->kabulEkle2Response;
