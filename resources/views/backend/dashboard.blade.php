...
@if(env('MAIL_USERNAME') == null && env('MAIL_PASSWORD') == null)
    <div class="">
        <div class="alert alert-danger d-flex align-items-center">
            ...
            <a class="alert-link ml-2" href="{{ route('admin.smtp_settings.index') }}">{{ translate('Configure Now') }}</a>
        </div>
    </div>
@endif
...
<div class="card">
    ...
    <div class="card-body">
        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4" data-md-items="3" data-sm-items="2" data-arrows='true'>
            @foreach (filter_products(\App\Models\Product::where('published', 1)->orderBy('name', 'asc'))->limit(12)->get() as $key => $product)
