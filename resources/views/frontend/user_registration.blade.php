                                ...
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <input id="username" type="text" class="form-control {{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" required placeholder="{{ translate('Usernam&#8203;e') }}" autocomplete="off" onkeyup="checkusername(this)" >
