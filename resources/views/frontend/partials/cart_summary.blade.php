<div class="card rounded border-0 shadow-sm">
    <div class="card-header">
        ...
        <div class="text-right">
            ...
            @foreach ($carts as $key => $cartItem)
                @php $subtotal_for_min_order_amount += cart_product_price($cartItem, $cartItem->product, false, false) * 1; @endphp
            @endforeach
    ...
    <div class="card-body">
        @if (addon_is_activated('club_point'))
            ...
            @foreach ($carts as $key => $cartItem)
                @php
                    $product = \App\Models\Product::find($cartItem['product_id']);
                    $total_point += $product->earn_point * 1;
                @endphp
            @endforeach
                ...
                @foreach ($carts as $key => $cartItem)
                    ...
                    <tr class="cart_item">
                        ...
                        <td class="product-total text-right">
                            <span
                                class="pl-4 pr-0">{{ single_price(cart_product_price($cartItem, $cartItem->product, false, false) * 1) }}</span>
                        </td>
                    </tr>
                @endforeach
            </tbody>
